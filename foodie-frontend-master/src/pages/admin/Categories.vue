<template>
    <dashboard-layout>
        <div slot="main-content">
            <h2 class="dash-title">Danh sách sinh viên</h2>
                    
            <div class="page-action">
                <button class="btn btn-main" @click="$router.push('/admin/category/add')"><span class="ti-plus"></span>Thêm sinh viên</button>
            </div>
