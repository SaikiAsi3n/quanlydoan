        ...
        <div>
            <div>
                <div class="account-header">
                    <h3><span class="ti-bolt"></span> PTIT</h3>
                    <small>Đồ án tốt nghiệp</small>
                </div>

                <div class="account-tabs">
                    <button :class="isActive === 0? 'is-active': ''" @click="isActive = 0">Đăng nhập</button>
                    <button :class="isActive === 1? 'is-active': ''" @click="isActive = 1">Đăng kí</button>
                </div>
